...
void OdyPatch::setCtrlValue(unsigned char bank, unsigned char ctrl, unsigned char newValue)
{
...
unsigned char OdyPatch::getCtrlValue(unsigned char bank, unsigned char ctrl)
{
